...
recombination_file_name = "combinedCatOnlyBestWithPVals_7_2.txt"
sampleinfo_file_name = "sampleInfo_7_2.txt"
relevent_sites_file_name = "allRelevantNodesInfSites_7_2.txt"
